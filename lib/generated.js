...
function peg$parse(input, options) {
  ...
  var peg$FAILED = {},
      ...
      peg$c0 = function(keys) {
          ...
          log.success('Value mapped', value);
          return value;
        },
      peg$c1 = ":",
      ...
      peg$c4 = function(indent, key, type, regex, children) {
          log.f.log('Reading type %bu at key %bu', type.name, key);

          type.addRegExp(regex);
      ...
      peg$c29 = function(regex) {
          if (regex) {
            const exp = regex[1].join('');
            log.f.debug('Regex found %bu', exp);
      ...
      peg$c38 = function(first, rest) {
          ...
          log.f.debug('Found identifier %bu', id);
          return id;
        },
      peg$c39 = /^[ ]/,
      peg$c40 = peg$classExpectation([" "], false, false),
      peg$c41 = function(spaces) {
